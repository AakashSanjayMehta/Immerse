    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        if UserDefaults.standard.string(forKey: "place name") != nil {
            ...
            case "Cafe":
                ...
                Place_description.text = "The good news cafe has a wide variety of chill and western food and drinks at cheap prices. These includes, hot dogs, sandwiches, ice creams and even tea. The seats outside the cafe gives students a quiet place to study, eat or just hangout "
            ...
            case "Robotics@apex": // NOT DONE
                ...
                Place_image.image = UIImage(named: "")
                Place_description.text = "This area outside the robotics room is also dedicated to the robotics students. However other students may also occupy this area for project meetings and work."
                view360_identifier = ""
            ...
            case "Makers'_Lab":
                ...
                Place_description.text = "The SST Maker Lab is a fully equipped learning zone where students can design, prototype and manufacture products. ‘Makerspaces’ are a fairly new phenomenon, but are beginning to make waves in the field of education. The SST Maker Lab represents the democratisation of design, engineering, fabrication and education, and empowers our students with the resources to unleash their creativity"
                view360_identifier = "Makers_Lab"
                
            case "Canteen":
                Place_name.text = "Canteen"
                Place_image.image = UIImage(named: "Canteen_1a")
                Place_description.text = "Canteen has a variety of healthy food and drinks available for the students from early in the morning to after school afternoon. This is where SST students usually hang out because our food is irresistible. "
